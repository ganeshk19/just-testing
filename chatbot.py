...
def Creator():
    speak("GANESH is an extra-ordinary person ,"
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'time' in query:
            ...
            speak("Thanks to GANESH. further it is a secret")
        elif 'word' in query:
            ...
            Introduction()
        elif 'tell me about myself' and 'creator' in query:
            Creator()
